...
<x-layout title="Publikasi">
    ...
    <x-ui.card>
        ...
        <x-ui.modal id="form-modal" title="Tambah Pengeluaran">
            <form action="{{ route('publikasi.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                @csrf
                <!-- Modal body -->
                <div class="p-4 md:p-5 space-y-4">
                    <x-form.input label="Judul" id="judul" name="judul" :required="true" />
                    <x-form.select name="jenis_publikasi" id="jenis_publikasi" label="Jenis Publikasi">
                    ...
                    <x-form.input label="Tahun Anggaran" id="tahun_anggaran" name="tahun_anggaran" :required="true" />
                    <x-form.textarea name="deskripsi" label="Deskripsi" id="deskripsi"
                        :required="true"></x-form.textarea>
                    <x-form.input type="date" name="tanggal_publikasi" label="Tanggal Publikasi"
                        id="tanggal_publikasi" :required="true" />
                    <x-form.file name="file" label="File" id="file" :required="true" />
                </div>
                <!-- Modal footer -->
                <div
